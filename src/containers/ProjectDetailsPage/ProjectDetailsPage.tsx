...
import NatSimons from "images/artists/NatSimons.jpeg";
...
const ProjectDetailsPage: FC<ProjectDetailsPageProps> = ({ className = "", isPreviewMode }) => {
    ...
    return (
      <div className="divide-y divide-neutral-100 dark:divide-neutral-800">
        ...
        <div className="pb-9 space-y-5">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-semibold">Macabro Plan</h2>
        ...
        <div className="pb-9 pt-14">
          <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between">
            <div className="flex-1 flex flex-col sm:flex-row items-baseline p-6 border-2 border-green-500 rounded-xl relative">
              <span className="absolute bottom-full translate-y-1 py-1 px-1.5 bg-white dark:bg-neutral-900 text-sm text-neutral-500 dark:text-neutral-400">Price per share</span>
              <span className="text-3xl xl:text-4xl font-semibold text-green-500">125.000 USDC</span>
              {/* <span className="text-lg text-neutral-400 sm:ml-5">( ≈ $3,221.22)</span> */}
            </div>

            <span className="text-sm text-neutral-500 dark:text-neutral-400 ml-5 mt-2 sm:mt-0 sm:ml-10">[593 shares still available]</span>
          </div>
          ...
          <div className="mt-8 flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-3">
            <ButtonPrimary href={"/connect-wallet"} className="flex-1">
              ...
              <span className="ml-2.5">Purchase 10 shares</span>
            </ButtonPrimary>
            <ButtonSecondary href={"/connect-wallet"} className="flex-1">
              ...
              <span className="ml-2.5"> More share options</span>
            </ButtonSecondary>
          </div>
        </div>
  ...
  return (
    <div className={`nc-ProjectDetailsPage  ${className}`} data-nc-id="ProjectDetailsPage">
      {/* MAIn */}
        ...
        <div className="w-full grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-14">
          ...
          <div className="space-y-8 lg:space-y-10">
            ...
            <div className="relative">
              <NcImage src={NatSimons} containerClassName="aspect-w-11 aspect-h-12 rounded-3xl overflow-hidden" />
              {/* META TYPE */}
          ...
          {/* SIDEBAR */}
          <div className="pt-10 lg:pt-0 xl:pl-10 border-t-2 border-neutral-200 dark:border-neutral-700 lg:border-t-0">{renderSection1()}</div>
        </div>
      </main>
    </div>
  );
