...
const SectionHero: FC<SectionHeroProps> = ({ className = "", heading = "Discover and invest in your favorite music", subHeading = "Discover the most outstanding NTFs in all topics of life. Creative your NTFs and sell them" }) => {
  return (
