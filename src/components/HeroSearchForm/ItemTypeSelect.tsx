...
const ItemTypeSelect: FC<ItemTypeSelectProps> = ({ onChange, fieldClassName = "[ nc-hero-field-padding ]" }) => {
  return (
        ...
        <>
          ...
          >
            ...
            <div className="flex-grow">
              ...
              <span className="block mt-1 text-sm text-neutral-400 leading-none font-light ">Type of item</span>
            </div>
          </Popover.Button>
