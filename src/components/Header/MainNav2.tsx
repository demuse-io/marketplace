...
const MainNav2: FC<MainNav2Props> = () => {
  return (
    <div className={`nc-MainNav2 relative z-10 ${"onTop "} bg-white`}>
      <div className="container py-5 relative flex justify-between items-center space-x-4 xl:space-x-8">
        ...
        <div className="flex-shrink-0 flex items-center justify-end text-neutral-700 dark:text-neutral-100 space-x-1">
          <div className="hidden items-center xl:flex space-x-2">
            ...
            <SwitchDarkMode />
            <ButtonPrimary href={"/page-upload-item"} sizeClass="px-4 py-2 sm:px-5">
              Create
            </ButtonPrimary>
            <ButtonSecondary href={"/connect-wallet"} sizeClass="px-4 py-2 sm:px-5">
              Connect Wallet
            </ButtonSecondary>
          </div>
