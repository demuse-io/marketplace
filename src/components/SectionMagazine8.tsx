  ...
  return (
    <div className={`nc-SectionMagazine8 relative ${className}`}>
      ...
      <div className={`grid grid-cols-1 sm:grid-cols-6 gap-6 2xl:gap-8`}>
        <CardNFTMusic featuredImage={berto} className="sm:col-span-3 xl:col-span-2" audioSrc="" title="" />
        <CardNFTMusic featuredImage={nat} className="sm:col-span-3 xl:col-span-2" audioSrc="" title="" />
